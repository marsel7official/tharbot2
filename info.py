...
URL = "https://tharfilte-45380db75050.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://tharfilte-45380db75050.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://tharfilte-45380db75050.herokuapp.com/".format(FQDN)
else:
    URL = "https://tharfilte-45380db75050.herokuapp.com/".format(FQDN)
