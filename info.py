...
URL = "https://filterboth-91cfd99e0550.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://filterboth-91cfd99e0550.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filterboth-91cfd99e0550.herokuapp.com/".format(FQDN)
else:
    URL = "https://filterboth-91cfd99e0550.herokuapp.com/".format(FQDN)
