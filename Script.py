...
‣ ᴍʏ ɴᴀᴍᴇ : <a href=https://t.me/Marsel_Filter_Bot>Marsel Bot 🇮🇳</a>
 ‣ My best friend : <a href='tg://settings'>ᴛʜɪs ᴘᴇʀsᴏɴ</a> 
 ‣ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/MarselBotz'>Mᴀʀsᴇʟ 🇮🇳</a> 
...
Where is source code? - <a href='https://t.me/MarselBotz'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>


Developer - <a href='https://t.me/MarselBotz'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>"""
...
☀️ Languages : Hɪɴᴅɪ ᴀɴᴅ Mᴀʟᴛʏ Aᴜᴅɪᴏ
📀 RunTime: {runtime} Minutes
📆 Release Info : {release_date}
📽️Uᴘʟᴏᴅᴇᴅ Bʏ @MarselMovie\n
🎛 Release Countries : <code>{countries}</code>
...
-Dev 1 [Owner of this bot ]<a href='https://t.me/MarselBotz'>Mᴀʀsᴇʟ🇮🇳</a>
